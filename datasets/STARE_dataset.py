...
class STARE_Dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.dataset_type == 'stare':
        ...
        elif self.dataset_type == 'stare_fractal':
            ...
            sample = {"image": image_chw,
                      "mask": mask_,
                      "ID": os.path.split(img_path)[1]}
        elif self.dataset_type == 'stare_copy':
            img = cv2.imread(img_path, 0)
            mask = cv2.imread(mask_path, 0)
            img_ = img_PreProc_retina(img, pro_type='clahe')
            ...
            sample = {"image": image_chw,
                      "mask": mask_,
                      "ID": os.path.split(img_path)[1]}
        elif self.dataset_type == 'stare_fractal_three_decoder':
            npy_path = img_path.replace("images", self.fractal_dir)
            npy_path = npy_path[:-4] + ".npy"
            fractal_info = np.load(npy_path)
            img_FD, img_FL = npy_PreProc(fractal_info)
            ...
            if self.train:
                edge_path = mask_path.replace('masks_aug', self.edge_dir)
                skeleton_path = mask_path.replace('masks_aug', self.skeleton_dir)
                ...
                sample = {"image": image_chw,
                          "mask": mask_,
                          "ID": os.path.split(img_path)[1]}
        elif self.dataset_type == 'stare_fractal_two_decoder':
            npy_path = img_path.replace("images", self.fractal_dir)
            npy_path = npy_path[:-4] + ".npy"
            fractal_info = np.load(npy_path)
            img_FD, img_FL = npy_PreProc(fractal_info)
            ...
            if self.train:
                ...
                sample = {"image": image_chw,
                          "mask": mask_,
                          "ID": os.path.split(img_path)[1]}
        elif self.dataset_type == 'stare_three_decoder':
            img = cv2.imread(img_path, 0)
            mask = cv2.imread(mask_path, 0)
            img_ = img_PreProc_retina(img, pro_type='clahe')
            ...
            if self.train:
                ...
                sample = {"image": image_chw,
                          "mask": mask_,
                          "ID": os.path.split(img_path)[1]}
        elif self.dataset_type == 'stare_fractal_three_decoder_weighted':
            ...
            weight_path = mask_path.replace('masks_aug', 'masks_aug' + self.weight_dir)
