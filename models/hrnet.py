...
class HRNetV2(nn.Module):
    def __init__(self, n_channels, n_class, **kwargs):
        ...
        extra = {
            ...
            'STAGE3': {'NUM_MODULES': 1, 'NUM_BRANCHES': 3, 'BLOCK': 'BASIC', 'NUM_BLOCKS': (4, 4, 4),
                       'NUM_CHANNELS': (32, 64, 128), 'FUSE_METHOD': 'SUM'},
            'STAGE4': {'NUM_MODULES': 1, 'NUM_BRANCHES': 4, 'BLOCK': 'BASIC', 'NUM_BLOCKS': (4, 4, 4, 4),
                       'NUM_CHANNELS': (32, 64, 128, 256), 'FUSE_METHOD': 'SUM'},
            'FINAL_CONV_KERNEL': 1
        }

        # stem net
        self.conv1 = nn.Conv2d(self.n_channels, 64, kernel_size=3, stride=1, padding=1,
                               bias=False)
