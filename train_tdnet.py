...
from models.md_net import Two_decoder_Net
...
def train_eval_model(opts):
    ...
    shutil.copy("./train_tdnet.py", os.path.join(model_dir, "train_tdnet.py"))
    ...
    dataloaders_dict = {
        "train": build_data_loader(dataset_name, train_data_dir, train_batch_size, dataset_type, is_train=True,
                                   fractal_dir=fractal_dir,edge_dir=edge_dir,skeleton_dir=skeleton_dir, decoder_type=decoder_type),
        "eval": build_data_loader(dataset_name, eval_data_dir, val_batch_size, dataset_type, is_train=False,
                                  fractal_dir=fractal_dir, decoder_type=decoder_type)}
...
if __name__ == '__main__':
    ...
    opts = dict()
    opts['dataset_type'] = 'er_fractal_two_decoder'
    ...
    log_dir = "./train_logs/" + str(opts["dataset_type"]) + '_' + opts["model_type"] + '_' + opts[
        "decoder_type"] + "_iou_bce_loss_one_half_" + \
